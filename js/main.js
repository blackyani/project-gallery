(function ($) {
    ...
    //Variables
    let $projects = $('.projects'), //Project containe
        ...
        tlProjects, tlproject =  new TimelineMax({repeat: -1, repeatDelay: 2});
    ...
    tlCircles
        ...
        .to($projectImageAfter, 0.7, {cssRule:{right:'-6px'}, ease:Linear.easeNone}, '1.');
